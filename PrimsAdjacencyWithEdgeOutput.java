...
import java.util.*;
class PrimsAdjacencyWithEdgeOutput
{
	private int V;
			...
			if(!isVertexIncluded(mstSet,node))
			{
				...
				for(int z=0;z<this.V;z++)
				{
					if(graph[i][z]!=0 ) 
					{
							...
							if(parent[z]==-1)//solved yesssssss!, to print edges start from parent[1], since 0th element is redundant
								parent[z]=i;
					}
				}
			}
	...
	public static void main (String[] args)
    {
       ...
       6| 8/    \5 |7
        ...
        (3)-------(4)
             9          */
        PrimsAdjacencyWithEdgeOutput t = new PrimsAdjacencyWithEdgeOutput();
        int graph[][] = new int[][] {
									{0, 2, 0, 6, 0},
                                    {2, 0, 3, 8, 5},
                                    {0, 3, 0, 0, 7},
